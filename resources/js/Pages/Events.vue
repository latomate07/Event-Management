...
import ListItem from "@/Jetstream/ListItem.vue";
...
<template>
    ...
    <div class="pace-y-4 mx-20" v-if="$page.props.user">
        <header
            class="bg-white shadow space-y-4 p-4 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6"
        >
            ...
            <form class="group relative">
                ...
                <Input
                    ...
                    placeholder="Filtrer les évenements..."
                ></Input>
            </form>
        </header>
        ...
        <div class="divide-y divide-slate-100 my-5 mx-2">
            ...
            <List>
                ...
                <ListItem class="bg-white shadow my-5"></ListItem>
                <ListItem class="bg-white shadow my-5"></ListItem>
                <ListItem class="bg-white shadow my-5"></ListItem>
            </List>
        </div>
